...
test:
    ...
    ./sivq -in data/tumor.png -out test/tumor-pink.png -X 444 -Y 143 -I 2 -S 5 -R 3 -M 6
    ./sivq -in data/tumor2x.png -out test/tumor2x-pink.png -X 888 -Y 286 -I 2 -S 5 -R 3 -M 6
